...
#applying anova test
#For anova test lets first define null and alternative hypothesis
#Ho:The means of nuclear localization signals of the different groups are same
#Ha:At least one sample mean is not equal to the others

result <- aov(nuc ~ class, data=yeast_data)
summary(result)

#yeast_data is our dataset
#As the p-value is less than the significance level 0.05, we can conclude that there is significant 
